...
Safely unfollow Instagram users generated by [this project](https://github.com/AmrDoma/Instagram-Follower-Scraper/tree/main). Built-in rate limiting and safety features to prevent account blocks.

This project was made to unfollow hundreds of irrelevant Instagram accounts over time to declutter my own social media account.

I shared this code because I spent hours looking for online methods, and it was either paid or outdated.

Using the format of this CSV, you can unfollow whichever accounts you want. I myself used the other repo to generate a CSV containing followers who don't follow me back (mostly the accounts I'm targeting like influencers and celebrities).

The end goal of this was to declutter my instagram account.

**NOTE**: I only use Instagram's API endpoints. These I found out myself by searching and interacting with official Instagram.

This code runs locally and connects directly to Instagram's service, so there shouldn't be any privacy concerns.

I unfollowed 200 accounts safely during my first hour, but this can differ from account to account.

⚠️ YOUR ACCOUNT MAY BE TEMPORARILY BLOCKED FROM DOING CERTAIN ACTIONS SUCH AS LIKING, FOLLOWING, OR UNFOLLOWING. USE AT YOUR OWN RISK
...
- ✅ **~50-100 unfollows/hour** is generally safe
- ✅ **~100-250 unfollows/day** maximum recommended
- This limit changes according to how active you are on your instagram page. Please use google for more accurate information.
